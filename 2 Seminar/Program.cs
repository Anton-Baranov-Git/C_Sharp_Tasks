...
//     if(number_text.Length > 2) Console.WriteLine($"Длина всего числа: {number_text.Length} Третья цифра числа \"{number}\" является \"{number_text[2]}\""); // если знаков больше 2 в числе печатаем ответ
...
=======
// Решение без преобразования строки
>>>>>>> 291b8bae13c8014f7bb7bee5670abc6f9efb2257
